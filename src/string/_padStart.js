/*
  Define a function to start-pad a specified string.
...
Note: This implementation does not use the String.prototype.padStart method,
because it is not included in ES2015.
*/
var _padStart = function(string, length, chars) {
