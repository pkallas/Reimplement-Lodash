/*
  Define a function to return a specified number rounded up with a specified
...
*/
var _ceil = function(number, precision) {
  /*
  ...
  */
  ...
  if (
    ...
    return Math.ceil(number * tenPower) / tenPower;
  }
